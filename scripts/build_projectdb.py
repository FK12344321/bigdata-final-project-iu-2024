...
conn_string="host=hadoop-04.uni.innopolis.ru port=5432 user=team23 dbname=team23_projectdb password={}".format(password)
...
with psql.connect(conn_string) as conn:
        ...
        with open(os.path.join("..", "sql", "import_data.sql")) as file:
                ...
                with open(os.path.join("..", "data","airbnb_preprocessed.csv"), "r") as depts:
                      cur.copy_expert(" ".join(commands), depts)
